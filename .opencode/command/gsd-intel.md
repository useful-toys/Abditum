...
Intel system is disabled. To activate:
  ...
  node C:/git/Abditum/.opencode/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node C:/git/Abditum/.opencode/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node C:/git/Abditum/.opencode/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node C:/git/Abditum/.opencode/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: C:/git/Abditum/.opencode/get-shit-done/bin/gsd-tools.cjs
