...
<execution_context>
@C:/git/Abditum/.opencode/get-shit-done/workflows/code-review-fix.md
</execution_context>
...
Execute the code-review-fix workflow from @C:/git/Abditum/.opencode/get-shit-done/workflows/code-review-fix.md end-to-end.
