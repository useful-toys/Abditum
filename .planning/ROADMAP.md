...
Plans:
- [ ] 03-01-PLAN.md — Domain Entities + Factory: Define Cofre, Pasta, Segredo, Modelo, Campo types, EstadoSessao enum, factory functions, error types, comprehensive entity tests
- [ ] 03-02-PLAN.md — Manager + Cofre Lifecycle: Manager struct, Lock with memory wiping, Salvar with atomic two-phase commit, timestamp tracking, lifecycle tests
