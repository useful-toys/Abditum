...
- [x] 06.2-03-PLAN.md — flow_create_vault.go + flow_save_and_exit.go: desvios 6, 7, 8, 9 (dirty-check, overwrite, senha fraca, conflito externo + N Salvar como novo)
- [x] 06.2-04-PLAN.md — help.go: formatKeyForHelp() + aplicar em buildContentLines() (desvio 10)
