...
Reference full template: `C:/git/Abditum/.gemini/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/git/Abditum/.gemini/get-shit-done/templates/state.md`.
