...
<!-- For checkpoint task examples and patterns, see @C:/git/Abditum/.gemini/get-shit-done/references/checkpoints.md -->
...
See `C:/git/Abditum/.gemini/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `C:/git/Abditum/.gemini/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `C:/git/Abditum/.gemini/get-shit-done/workflows/verify-phase.md` for verification logic.
